...
- `jpmc_takehome/src/preprocessing.py` – CLI for generating processed datasets (classification & segmentation variants).
- `jpmc_takehome/src/train_classification.py` – CLI to train the XGBoost classifier with hyperparameter search and MLflow logging.
- `jpmc_takehome/src/evaluate.py` – CLI to load an MLflow model and produce metrics/plots.
- `jpmc_takehome/src/segmentation.py` – rule-based segmentation CLI with weighted profiling.
